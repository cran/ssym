...
else plot(exp(x$z_es), x$cdf(x$z_es), main = "Survival function of the error", cex=0.3, lwd=3, xlab="Multiplicative Error", ylab="Survival Function")
...
plot(qnorm(1-surv0$surv[ids]),qnorm(x$cdfz(surv0$time[ids])), main="Overall goodness-of-fit statistic", cex=0.3, lwd=3, xlab="Empirical Distribution", ylab="Expected Distribution")}
abline(0,1)
